...
public class Patch_RingBuffer_IsStateChanged_B41 {
    ...
    public static final boolean ALL_FIELDS_FOUND = f_currentRun != null && f_currentUseAttribArray != null
        && f_currentTexture0 != null && f_currentTexture1 != null && f_currentStyle != null;
    ...
    public static void onExit(@Patch.This Object self,
        ...
        try {
            ...
            java.lang.Byte useAttrib = Accessor.tryGet(self, f_currentUseAttribArray, (byte) 0);
