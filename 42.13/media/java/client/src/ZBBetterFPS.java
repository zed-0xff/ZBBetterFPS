...
public class ZBBetterFPS {
    ...
    public static boolean g_OptimizeRainManager = false;
    public static boolean g_OptimizeInventoryItem = false;
    public static boolean g_OptimizeIsoZombie = false;
    ...
    public static void setOptimizeRainManager(boolean b) { g_OptimizeRainManager = b; }
    public static void setOptimizeInventoryItem(boolean b) { g_OptimizeInventoryItem = b; }
    public static void setOptimizeIsoZombie(boolean b) { g_OptimizeIsoZombie = b; }
